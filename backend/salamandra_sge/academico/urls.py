...
from .views import AlunoViewSet, DAEViewSet, TurmaViewSet, DisciplinaViewSet, RelatorioViewSet, DirectorTurmaViewSet, CoordenadorClasseViewSet, DelegadoDisciplinaViewSet
